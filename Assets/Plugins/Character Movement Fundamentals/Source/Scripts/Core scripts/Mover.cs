...
namespace CMF
{
	...
	public class Mover : MonoBehaviour
	{
		...
		void Awake()
		{
			...
			RecalibrateSensor(Sensor.CastDirection.Down);
		}
		...
		public void RecalculateColliderDimensions(Sensor.CastDirection castDirection = Sensor.CastDirection.Down)
		{
			...
			if (sensor != null)
				RecalibrateSensor(castDirection);
		}

		//Recalibrate sensor variables;
		public void RecalibrateSensor(Sensor.CastDirection castDirection)
		{
			//Set sensor ray origin and direction;
			sensor.SetCastOrigin(GetColliderCenter());
			sensor.SetCastDirection(castDirection);
